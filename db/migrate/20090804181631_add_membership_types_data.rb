class AddMembershipTypesData < ActiveRecord::Migration
  ...
  def self.up
    ...
    @membership_type = MembershipType.create(:max_projects_listed => 5,
      :pc_limit => 5, :pc_project_limit => 5, :funding_limit_per_project => 50000)
    ...
    @membership_type = MembershipType.create(:max_projects_listed => 10,
      :pc_limit => 10, :pc_project_limit => 10, :funding_limit_per_project => 1000000)
    @membership_type.name = 'Gold'
    @membership_type.save!

    @membership_type = MembershipType.create(:max_projects_listed => 25,
      :pc_limit => 25, :pc_project_limit => 25, :funding_limit_per_project => 2500000)
    @membership_type.name = 'Platinum'
    @membership_type.save!

    @membership_type = MembershipType.create(:max_projects_listed => -1,
      :pc_limit => -1, :pc_project_limit => -1, :funding_limit_per_project => -1)
    @membership_type.name = 'Black Pearl'
    @membership_type.save!
    #eg: "if membership_type.max_projects_listed == -1", no limits apply
